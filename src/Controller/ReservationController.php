...
class ReservationController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager,FlashyNotifier $flashy ): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->flush();
            $flashy->success('Reservation succefully', 'http://your-awesome-link.com');
    ...
    public function newB(Request $request, EntityManagerInterface $entityManager ,Evenement $idevent,FlashyNotifier $flashy ): Response
    {
        $reservation = new Reservation();
    ...
    public function newFront(Request $request, EntityManagerInterface $entityManager ,Evenement $idevent,FlashyNotifier $flashy ): Response
    {
        $reservation = new Reservation();
        $reservation->setIdevenement($idevent);
